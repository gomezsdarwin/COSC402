...
if (isset($_POST['submit'])) {
    ...
    $query = "INSERT INTO pledges(id,fruit,vegetables,cannedbeans,cannedsoup,cannedchicken,cannedfish) VALUES ('$user', '$fruit', '$vegetables','$cannedBeans','$cannedSoup','$cannedChicken','$cannedFish')";
...
<section class="header">
	...
	<div class = "input">
		...
		<form method="post" action="customer_donate.php">
